// This config was directly modeled after the default TailwindCSS 3.1.2 config.  Even the ordering
// of children was intentionally kept the same for maintainability. The original can be found at
// https://github.com/tailwindlabs/tailwindcss/blob/4a745439f010aca2ea24bb7fd9ab0ac3e15a40c1/stubs/defaultConfig.stub.js

// This is a very expensive function that creates a lot of classes. This is done at built-time and
// most things are kept out of the bundle due to Tailwind JIT, so this isn't too big of an issue,
...
const config = {
  ...
  theme: {
    ...
    ringColor: ({ theme }) => ({
      DEFAULT: theme(`colors.accent.DEFAULT`, '#016FB9'),
      ...theme('colors'),
    }),
